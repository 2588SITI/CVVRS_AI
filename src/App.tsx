      ...
      <nav className="relative z-10 border-b border-white/5 backdrop-blur-2xl bg-black/40 sticky top-0">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-10">
            ...
            <a href="#" className="text-xs font-bold uppercase tracking-widest text-white/40 hover:text-white transition-all">Archives</a>
            <button className="px-6 py-2.5 bg-white/5 border border-white/10 rounded-full text-[10px] font-black uppercase tracking-widest hover:bg-white/10 transition-all backdrop-blur-md">
              System Health
            </button>
          </div>
        </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="space-y-3">
                      ...
                      <textarea 
                        ...
                        placeholder="Specify unique locomotive conditions or crew details..."
